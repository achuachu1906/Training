...
public class Student implements Comparable<Student> {
	...
	//if we put otherObj instead of this means-->it will print the output as ascending order
	//if we put this instead of otherObj means-->it will print the output as descending order
